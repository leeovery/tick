...
allowed-tools: Bash(node .claude/skills/continue-cross-cutting/scripts/discovery.js), Bash(node .claude/skills/workflow-manifest/scripts/manifest.js)
---
...
!`node .claude/skills/continue-cross-cutting/scripts/discovery.js`
